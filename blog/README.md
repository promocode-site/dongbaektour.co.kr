# 블로그 폴더 설명 (www.dongbaektour.co.kr)
...
주소는 `https://www.dongbaektour.co.kr/blog/agoda-coupon/` 가 됩니다.
...
| `{{canonical}}` | 글의 정식 주소 | https://www.dongbaektour.co.kr/blog/agoda-coupon/ |
